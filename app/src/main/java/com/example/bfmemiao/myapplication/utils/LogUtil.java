...
//			saveString(tag, msg);
	...
	public static void LogMC(String msg) {
//		Log.e("","/**************************************************************************/\n");
		if (!isRelease) {
			...
			for (int i = 0; i < 100; i++) {
				if (strLength > end) {
					Log.e("MC___" + i, msg.substring(start, end));
					start = end;
					end = end + LOG_MAXLENGTH;
				} else {
					Log.e("MC___" + i, msg.substring(start, strLength));
					break;
				}
			}
		}
	...
	public static void LogMC(String type, String msg) {
